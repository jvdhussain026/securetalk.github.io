...
import { ArrowLeft, KeyRound, LoaderCircle, Shield, Check, X, Eye, EyeOff } from 'lucide-react';
      ...
      <header className="flex items-center gap-4 p-4 shrink-0 bg-card border-b">
        <Button variant="ghost" size="icon" asChild>
          <Link href="/settings/account">
            ...
            <span className="sr-only">Back to My Account</span>
          </Link>
        </Button>
        <h1 className="text-2xl font-bold font-headline">Change Password</h1>
      </header>
