...
import { collection, doc, query, serverTimestamp, addDoc, setDoc } from 'firebase/firestore';
...
export default function GroupInvitePage() {
  ...
  const handleSendInvites = async () => {
    ...
    const promises = selectedContacts.map(async contactId => {
        ...
        return setDoc(userContactRef, { lastMessageTimestamp: serverTimestamp() }, { merge: true });
    });
